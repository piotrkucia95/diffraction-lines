...
class Database:
    ...
    def save_calculation(self, calc):
        query = """
                    INSERT INTO calculations(id, advanced, element_a_id, element_b_id, n_a, m_b, n, w_a, w_b, g_a, g_b, theta_2_min, theta_2_max, d_a_custom, d_b_custom, lambda) 
                    VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
                """
        cur = self.conn.cursor()
        calc_id = uuid.uuid4()
        cur.execute(query, (str(calc_id), calc.advanced, calc.element_a.id, calc.element_b.id, calc.n_a, calc.m_b, calc.n, calc.w_a, 
                            calc.w_b, calc.g_a, calc.g_b, calc.theta_2_min, calc.theta_2_max, calc.d_a_custom, calc.d_b_custom, calc.lambda_length),)
        self.conn.commit()
        cur.close()
    ...
    def get_calculations(self):
        ...
        for r in results:
            el_a = Element(r[17], r[18], r[19], r[20], r[21])
            el_b = Element(r[22], r[23], r[24], r[25], r[26])
            calc = Calculation(r[0], r[12], el_a.__dict__, el_b.__dict__, r[3], r[4], r[5], r[6], r[7], r[8], r[9], r[10], r[11], r[13], r[14], r[15], r[16])
    ...
    def update_calculation(self, id):
        ...
        el_a = Element(r[17], r[18], r[19], r[20], r[21])
        el_b = Element(r[22], r[23], r[24], r[25], r[26])
        calc = Calculation(r[0], r[12], el_a, el_b, r[3], r[4], r[5], r[6], r[7], r[8], r[9], r[10], r[11], r[13], r[14], r[15], r[16])
